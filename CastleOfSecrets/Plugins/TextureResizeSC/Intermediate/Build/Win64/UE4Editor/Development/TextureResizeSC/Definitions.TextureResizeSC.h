...
#define UE_PROJECT_NAME CastleOfSecrets
#define UE_TARGET_NAME UE4Editor
#define UE_MODULE_NAME "TextureResizeSC"
#define UE_PLUGIN_NAME "TextureResizeSC"
...
#define TEXTURERESIZESC_API DLLEXPORT
